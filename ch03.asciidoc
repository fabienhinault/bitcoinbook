...
Now, run the Bitcoin Core client. The first time you run it, it will rebuild the bitcoin blockchain by downloading all the blocks, which totalize 20 GB to download. It can spend several hours even with a good network link.
